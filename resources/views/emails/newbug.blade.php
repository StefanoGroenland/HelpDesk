...
<strong>Beste medewerker,</strong>
<p>Nieuwe feedback melding heeft plaats gevonden.</p><hr>
<p>Prioriteit = {{ $prioriteit }}</p>
<p>Soort = {{ $soort }}</p>
<p>Klantnummer = {{ $klant_id }}</p>
<p>Projectnummer = {{ $project_id }}</p>
<p>Omschrijving = {!! $beschrijving !!}</p>
...
Dit is een geautomatiseerd bericht die wordt verzonden zodra er feedback wordt geplaatst. <br>
</p>
</div>
</div>
